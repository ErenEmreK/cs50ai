        ...
        if people[person]["mother"] != None:
            ...
            for parent in (mother, father):
                if parent in one_gene:
                    ...
                    prob_map[parent] = 1 - PROBS["mutation"]
                else:
                    prob_map[parent] = PROBS["mutation"]
...
def normalize(probabilities):
    ...
    for person in probabilities:
        ...
        for value in probabilities[person]["gene"]:
            number += probabilities[person]["gene"][value]
        for value in probabilities[person]["gene"]:
            probabilities[person]["gene"][value] /= number
        
        number = 0
        for value in probabilities[person]["trait"]:
            number += probabilities[person]["trait"][value]
        for value in probabilities[person]["trait"]:
            probabilities[person]["trait"][value] /= number
